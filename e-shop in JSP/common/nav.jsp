...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  <a class="navbar-brand" href="index.jsp">Παραδοσιακα Ζυμαρικα Μεγαλόπολης</a>
  <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="login.jsp" class="nav-link">Είσοδος</a></li>
          <li class="nav-item"><a href="registration.jsp" class="nav-link">Εγγραφή</a></li>
